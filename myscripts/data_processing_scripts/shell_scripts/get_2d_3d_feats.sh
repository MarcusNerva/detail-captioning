...
echo "Greetings, Henry! I am glad to inform you that data extraction is finished, and now is copying data to data_store!" \
    | mail -s "Data Extraction Finished!" hadrianus_1@163.com
