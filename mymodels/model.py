...
class CaptionModel(nn.Module):
    ...
    def sample_beam(self, res2ds, i3ds, relations, objects, res_mask, i3d_mask):
        ...
        for i in range(batch_size):
            ...
            single_relation = single_relation.expand(beam_size, single_relation.size(0), single_relation.size(1))
            single_object = single_object.expand(beam_size, single_object.size(0), single_object.size(1))
